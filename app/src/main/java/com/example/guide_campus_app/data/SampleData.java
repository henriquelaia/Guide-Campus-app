...
public class SampleData {
    ...
    private static void populateLocations(LocationDao dao) {
        LocationEntity[] locations = {
            ...
            createLocation("Centro Clínico Ciências da Visão", "Saúde / Serviços", "Clínica de Optometria e Ciências da Visão", "Localizado no Polo I, junto ao Departamento de Informática. Disponibiliza consultas e exames.", 40.27694, -7.50905, "Dias úteis: 09h00–17h00", "Atendimento preferencial por marcação.", "ubi_ciencias_visao"),

            createLocation("Departamento de Informática - UBI", "Departamento / Faculdade", "Edifício do Departamento de Informática (DI)", "Localizado no Caminho do Biribau, Polo I. O edifício é também conhecido como Sexta Fase.", 40.27730, -7.50961, "Dias úteis: 09h-18h", "", "ubi_bloco_engenharias"),
            createLocation("Serviços de Informática - UBI", "Serviços", "Serviços de Informática (SI)", "Helpdesk e apoio técnico. Localizado no edifício da Faculdade de Ciências.", 40.2777, -7.5092, "Dias úteis: 09h-17h", "Atendimento presencial sujeito a marcação.", "ubi_dep_matematica"),
            createLocation("Faculdade de Ciências - UBI", "Faculdade / Departamentos", "Edifício principal da Faculdade de Ciências", "Agrega vários departamentos, incluindo Física e Química.", 40.27788, -7.50900, "Dias úteis: 08h-20h", "", "ubi_bloco_engenharias"),
            createLocation("Departamento de Física - UBI", "Departamento", "Departamento de Física", "Localizado no edifício da Faculdade de Ciências, Polo I.", 40.27788, -7.50900, "Dias úteis: 09h-18h", "Secretaria no piso de entrada.", "ubi_dep_matematica"),
            createLocation("Departamento de Química - UBI", "Departamento", "Departamento de Química", "Localizado no edifício da Faculdade de Ciências, Polo I.", 40.2779, -7.5088, "Dias úteis: 09h-18h", "Secretaria no piso de entrada.", "ubi_dep_matematica")
        };
